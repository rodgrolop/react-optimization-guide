...
const MaterialUIIcon = (): ReactElement => {
  return (
    <svg width="100%" height="100%" version="1.1" viewBox="0 0 21.331 16.933">
      <g transform="translate(-12.263 -225.84)">
        <g transform="matrix(.035552 0 0 .035552 12.263 225.84)">
          <path
